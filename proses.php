...
class proses extends fb{
		...
		if (!file_exists($file)){
			$arr	= [
				...
				'info'	=> [
					[
						'Aplikasi Jam-Masjid',
						'Selamat datang di Jam-Masjid, aplikasi baru saja diinstal dan belum ada data, silakan masuk ke menu admin untuk mengganti data',
						true	// active?
					],
					[
						'Info non-active',
				...
				'running_text' => [
					'Selamat datang di aplikasi Jam-Masjid',
	...
	private function info(){
		...
		foreach($db[$id] as $k => $v){
			...
			$title	= is_int($k)?'Info '.($k+1):'Tambah Info';
	...
	private function wallpaper(){
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<div class="box box-info">
				...
				<div class="box-footer">
					<button type="submit" class="btn btn-primary pull-left"><i class="fa fa-upload" aria-hidden="true"></i> Kirim</button>
				</div>
			</div>
			</form>
		</div>
		...
		<div class="col-md-4 col-sm-6 col-xs-12">
          <div class="small-box" style="background-image: url(display/wallpaper/<?=$v?>);">
            <div class="inner"></div>
            <a href="javascript:void(0)" data-file="<?=$v?>" class="small-box-footer"><i class="fa fa-trash"></i> hapus</a>
          </div>
        </div>
		<?php 
		endforeach;
			...
			<div class="nav-tabs-custom">
				...
				<div class="tab-content">
				  ...
				  <div class="tab-pane" id="info" >
					...
					<br><br>
					Contoh penggunaan untuk kota sidorejo mengkuti metode kemenag Lam-sel :
					<pre>
latitude	= -5.5855221
longitude	= 105.5187323
timeZone	= 7 (GMT +7)
fajr		= 20°
asr		= Standard (Shafii, Maliki, Jafari and Hanbali / shadow factor = 1)
isha		= 18°
					</pre>
					<small>Default aplikasi ini menggunakan setting <b>Sidomulyo - Lampung-Selatan - Lampung - indonesia</b> dengan metode seperti diatas</small>
				  </div>
					  ...
					  <ul class="nav nav-stacked">
						...
						<li>
							<a class="row">
								...
								<div class="col-xs-7">Berbayar</div>
							</a>
						</li>
					  </ul>
					</div>
